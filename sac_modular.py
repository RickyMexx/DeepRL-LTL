...
if args.modular:
    writer_2 = SummaryWriter(logdir='runs/{}_SAC_2_{}_{}_{}'.format(writer_datetime, args.env_name,
                                                             args.policy, "autotune" if args.automatic_entropy_tuning else ""))

# Memory
memory_1 = ReplayMemory(args.replay_size)
if args.modular:
    memory_2 = ReplayMemory(args.replay_size)
...
for i_episode in itertools.count(1):
    ...
    if args.modular:
            writer_2.add_scalar('reward/train', episode_reward, i_episode)
    ...
    if i_episode % 50 == 0 and args.eval is True:
        ...
        if args.modular:
            writer_2.add_scalar('avg_reward/test', avg_reward, i_episode)
